<?php
	...
	try {
		...
		$myPDO->exec('CREATE TABLE IF NOT EXISTS sensors (record_id text, user text, accel_x real, accel_y real, accel_z real, quat_x real, quat_y real, quat_z real, quat_w real, workout text)');
