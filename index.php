<?php
	...
	try {
		...
		$myPDO->exec('CREATE TABLE IF NOT EXIST sensors (record_id text, name text, accel_x real, accel_y real, accel_z real, quat_x real, quat_y real, quat_z real, quat_w real, workout text)');
