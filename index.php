<?php
	...
	try {
		...
		$myPDO->query('CREATE TABLE IF NOT EXISTS sensors (record_id bigint, user varchar(32), accel_x real, accel_y real, accel_z real, quat_x real, quat_y real, quat_z real, quat_w real, workout varchar(32))');
